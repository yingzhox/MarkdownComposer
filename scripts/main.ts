...
function initializeEditor(i: number): void {
...
function initializeMD(md) {
    ...
    function injectLineNumbers(tokens, idx, options, env: any, self) {
        var line: number;
...
function injectFences(rules: any) {
    //modify fences
...
function renderHTML(i:number, parsed) {
    if (parsed === undefined) {
        return;
    }
...
function syncScroll(editor: any, i: number, direction: number) {
...
function animateScroll(elt, startValue: number, endValue : number, endCb) {
    if (currentEndCb) {
...
function markSelection(editor, i:number) {
